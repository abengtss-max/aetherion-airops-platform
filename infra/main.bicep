...
// -----------------------------------------------------------------------------
// Major-incident alerting
// A fixed-severity (Sev 1) Azure Monitor alert on Application Insights failed
// requests, wired to an action group so it is fully functional in the portal.
// -----------------------------------------------------------------------------
...
resource incidentAlert 'Microsoft.Insights/metricAlerts@2018-03-01' = {
  ...
  location: 'global'
  properties: {
    description: 'Sev1 major incident: Application Insights failed requests spiking across the platform.'
    severity: 1
    enabled: true
    scopes: [ appi.id ]
